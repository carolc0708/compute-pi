...
double compute_pi_leibniz_avx_unroll(size_t N)
{
    ...
    ymm1 = _mm256_set1_pd(1.0);
    ymm2 = _mm256_set1_pd(2.0);
    ymm3 = _mm256_setzero_pd();// first sum of pi
    ymm4 = _mm256_setzero_pd();// second sum of pi
    ymm5 = _mm256_setzero_pd();// third sum of pi
    ymm6 = _mm256_setzero_pd();// fourth sum of pi

    for (int i = 0; i <= N-16; i+=16) {
        ymm7 = _mm256_set_pd(i,i+1.0,i+2.0,i+3.0);
        ymm8 = _mm256_set_pd(i+4.0,i+5.0,i+6.0,i+7.0);
        ymm9 = _mm256_set_pd(i+8.0,i+9.0,i+10.0,i+11.0);
        ymm10 = _mm256_set_pd(i+12.0,i+13.0,i+14.0,i+15.0);

        ymm7 = _mm256_mul_pd(ymm7,ymm2);
        ymm8 = _mm256_mul_pd(ymm8,ymm2);
        ymm9 = _mm256_mul_pd(ymm9,ymm2);
        ymm10 = _mm256_mul_pd(ymm10,ymm2);

        ymm7 = _mm256_add_pd(ymm7,ymm1);
        ymm8 = _mm256_add_pd(ymm8,ymm1);
        ymm9 = _mm256_add_pd(ymm9,ymm1);
        ymm10 = _mm256_add_pd(ymm10,ymm1);

        ymm7 = _mm256_div_pd(ymm0,ymm7);
        ymm8 = _mm256_div_pd(ymm0,ymm8);
        ymm9 = _mm256_div_pd(ymm0,ymm9);
        ymm10 = _mm256_div_pd(ymm0,ymm10);
    ...
    _mm256_store_pd(tmp1,ymm3);
    _mm256_store_pd(tmp2,ymm4);
    _mm256_store_pd(tmp3,ymm5);
    _mm256_store_pd(tmp4,ymm6);
